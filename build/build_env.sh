...
export CB_GCS_BUILD_PATH=istio-release-pipeline-data/daily-build/krishna-test1
export CB_GCS_FULL_STAGING_PATH=istio-prerelease/daily-build/krishna-test1
export CB_GCS_MONTHLY_RELEASE_PATH=
export CB_GCS_RELEASE_TOOLS_PATH=istio-release-pipeline-data/release-tools/daily-build/krishna-test1
...
#fake
export CB_VERSION=krishna-test1
